Public Class OauthProvider
    ...
    Public Const GoogleProvider As Integer = 0
    ...
    ' 
    Public Shared Function CreateGoogleProvider(ByVal clientId As String, ByVal clientSecret As String) As OauthProvider
    ...
    Public Shared Function CreateGoogleProvider() As OauthProvider
        Return CreateGoogleProvider("1072602369179-aru4rj97ateiho9rt4pf5i8l1r01mc16.apps.googleusercontent.com", "Lnw8r5FvfKFNS_CSEucbdIE-")
    End Function
