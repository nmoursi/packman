...
#Region "Send E-mail without SMTP server to multiple recipients"
    ...
    Private Function _createMailForDirectSend(ByVal address As MailAddress) As SmtpMail
        ...
        Dim cur As Globalization.CultureInfo = New Globalization.CultureInfo("en-US")
        ...
        For i As Integer = 0 To _attachments.Count - 1
            mail.AddAttachment(_attachments(i))
        Next
...
#Region "Guess SMTP server for popular email providers"
