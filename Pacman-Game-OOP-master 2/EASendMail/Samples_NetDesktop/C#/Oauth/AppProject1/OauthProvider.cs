...
namespace EASendMail.Oauth
{
    ...
    public class OauthProvider
    {
        ...
        */
        public static OauthProvider CreateGoogleSmtpProvider(string clientId, string clientSecret)
        {
        ...
        public static OauthProvider CreateGmailApiProvider(string clientId, string clientSecret)
        {
            OauthProvider provider = new OauthProvider();
            provider.AuthUri = "https://accounts.google.com/o/oauth2/v2/auth";
            provider.TokenUri = "https://www.googleapis.com/oauth2/v4/token";
        ...
        public static OauthProvider CreateGmailApiProvider()
        {
            return CreateGmailApiProvider("499737360376-iqv4l8v02085jourush1ughrf4k5d1k6.apps.googleusercontent.com",
                                "hzfYFWlL0ZQT82xu1v_P3MTr");
        }
         ...
         *   http://127.0.0.1 (used for local HttpLisener)
         *   
        ...
        */
        ...
        public void ResetLocalRedirectUri()
        {
            switch (ProviderType)
            { 
                case MsLiveProvider:
        ...
        string _accessType = string.Empty;
        ...
        public bool UseHttpListener { set; get; }
