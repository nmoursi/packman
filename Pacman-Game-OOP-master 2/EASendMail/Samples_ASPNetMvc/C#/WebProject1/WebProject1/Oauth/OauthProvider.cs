...
namespace EASendMail.Oauth
{
    ...
    {
        public const int GoogleSmtpProvider = 0;
        public const int MsLiveProvider = 1;
        public const int MsOffice365Provider = 2;
        public const int GoogleGmailApiProvider = 3;
        ...
        */
        public static OauthProvider CreateGoogleSmtpProvider(string clientId, string clientSecret, string redirectUri)
        {
        ...
        public static OauthProvider CreateGoogleSmtpProvider()
        {
            return CreateGoogleSmtpProvider("1072602369179-aru4rj97ateiho9rt4pf5i8l1r01mc16.apps.googleusercontent.com",
                                "Lnw8r5FvfKFNS_CSEucbdIE-",
                                "http://localhost:54098/oauth/token");
        }
        ...
        public static OauthProvider CreateGoogleGmailApiProvider()
        {
            return CreateGoogleGmailApiProvider("499737360376-p37p9rjfdgpcbtgl9d5b2mstkci3idre.apps.googleusercontent.com",
                                "E3SlO2NEbnLs_M_6VmE5swaW",
                                "http://localhost:54098/oauth/token");
        }
        /*
         ...
         *   http://localhost:54098/oauth/token (test application uri)
        ...
        */
        public static OauthProvider CreateMsOffice365Provider(string clientId, string clientSecret, string redirectUri)
        {
            OauthProvider provider = new OauthProvider();
        ...
        {
            return CreateMsOffice365Provider("eccbabb2-3377-4265-85c1-ea2fb515f075", "QaR_RR:-5WqTY[nni9pdBr9xVybqrAu4", "http://localhost:54098/oauth/token");
        }
        ...
        {
            return CreateMsLiveProvider("eccbabb2-3377-4265-85c1-ea2fb515f075", "QaR_RR:-5WqTY[nni9pdBr9xVybqrAu4", "http://localhost:54098/oauth/token");
        }

        public int ProviderType { get; set; } = GoogleSmtpProvider;
