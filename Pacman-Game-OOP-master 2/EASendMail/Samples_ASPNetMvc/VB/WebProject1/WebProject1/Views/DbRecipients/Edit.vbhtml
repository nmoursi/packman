...
@Code
    ViewBag.Title = "Edit - Send email from ASP.NET MVC with Database integration"
End Code

<div style="margin: 20px auto 20px auto;">
    @Html.ActionLink("Samples", "Index", "Home") &gt; @Html.ActionLink("Recipient List", "Index") &gt; Edit Recipient
</div>
...
@Using (Html.BeginForm())
    ...
    @<div class="form-horizontal">
        <hr />
        @Html.HiddenFor(Function(model) model.RecipientId)
