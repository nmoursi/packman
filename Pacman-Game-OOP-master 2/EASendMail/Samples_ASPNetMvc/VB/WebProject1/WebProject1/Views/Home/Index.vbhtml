...
<div class="row">
    ...
    <div class="col-md-3">
        ...
        <p>Send email with Gmail/Microsoft XOAUTH2 authentication.</p>
        <p>
            @Html.ActionLink("Try now", "Index", "MyOauth", Nothing, New With {.class = "btn btn-default"})
        </p>
    </div>
