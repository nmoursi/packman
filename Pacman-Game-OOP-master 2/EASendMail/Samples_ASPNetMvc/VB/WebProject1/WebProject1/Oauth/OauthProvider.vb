Public Class OauthProvider
    ...
    ' http://localhost:55659/myoauth/token is current project redirect URI
    ...
    ' 
    Public Shared Function CreateGoogleSmtpProvider(ByVal clientId As String, ByVal clientSecret As String, ByVal redirectUri As String) As OauthProvider
    ...
    Public Shared Function CreateGoogleSmtpProvider() As OauthProvider
        Return CreateGoogleSmtpProvider("1072602369179-aru4rj97ateiho9rt4pf5i8l1r01mc16.apps.googleusercontent.com", "Lnw8r5FvfKFNS_CSEucbdIE-", "http://localhost:55659/myoauth/token")
    End Function

    Public Shared Function CreateGoogleGmailApiProvider(ByVal clientId As String, ByVal clientSecret As String, ByVal redirectUri As String) As OauthProvider
        Dim provider As OauthProvider = New OauthProvider()
        provider.AuthUri = "https://accounts.google.com/o/oauth2/v2/auth"
        provider.TokenUri = "https://www.googleapis.com/oauth2/v4/token"
        provider.RedirectUri = redirectUri
    ...
    Public Shared Function CreateGoogleGmailApiProvider() As OauthProvider
        Return CreateGoogleGmailApiProvider("499737360376-p37p9rjfdgpcbtgl9d5b2mstkci3idre.apps.googleusercontent.com", "E3SlO2NEbnLs_M_6VmE5swaW", "http://localhost:55659/myoauth/token")
    End Function
    ...
    ' */
    Public Shared Function CreateMsOffice365Provider(ByVal clientId As String, ByVal clientSecret As String, ByVal redirectUri As String) As OauthProvider
        Dim provider As OauthProvider = New OauthProvider()
    ...
    Public Shared Function CreateMsOffice365Provider() As OauthProvider
        Return CreateMsOffice365Provider("eccbabb2-3377-4265-85c1-ea2fb515f075", "QaR_RR:-5WqTY[nni9pdBr9xVybqrAu4", "http://localhost:55659/myoauth/token")
    End Function

    Public Shared Function CreateMsLiveProvider(ByVal clientId As String, ByVal clientSecret As String, ByVal redirectUri As String) As OauthProvider
        Dim provider As OauthProvider = New OauthProvider()
        provider.AuthUri = "https://login.microsoftonline.com/common/oauth2/v2.0/authorize"
        provider.TokenUri = "https://login.microsoftonline.com/common/oauth2/v2.0/token"
        provider.RedirectUri = redirectUri
    ...
    Public Shared Function CreateMsLiveProvider() As OauthProvider
        Return CreateMsLiveProvider("eccbabb2-3377-4265-85c1-ea2fb515f075", "QaR_RR:-5WqTY[nni9pdBr9xVybqrAu4", "http://localhost:55659/myoauth/token")
    End Function

    Public _providerType As Integer = GoogleSmtpProvider
