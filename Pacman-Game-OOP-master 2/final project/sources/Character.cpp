...
Character::Character(int intialRow, int intialColumn, float size, Board *board) : mCurrentRow(intialRow), mCurrentColumn(intialColumn), mSize(size),
...
Character &Character::setPositionOnWindow(sf::Vector2f position)
{
...
Character &Character::setSpeedTimer(int s)
{
	speedTimer = s;
	return *this;
}
